@extends('layouts.app')
@section('content')
    <div class="progress loading" id="PreLoaderBar" style="position: absolute; top: 0; left: 0; height: 100%; width: 100%;">
        <div class="panel">
    ...
    <div class="col-md-12 panel "  id="loading">
        <div class="">
            <div class="">
                <div class="">
                    ...
                    <div class="">
                        ...
                        <div class="col-sm-12">
                                ...
                                <ul class="list-inline text-center col-md-10 col-md-offset-1" role="tablist">
                                    <li role="presentation" class="center-block text-center @if($active == 1 or $active == null)active  @endif"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Entrées ({{count($recettesStatus1)}})</a></li>
                                    <li role="presentation" class="center-block text-center @if($active == 2 ) active @endif"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Plats ({{count($recettesStatus2)}})</a></li>
                                    <li role="presentation" class="center-block text-center @if($active == 3 ) active  @endif"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Desserts ({{count($recettesStatus3)}})</a></li>
                                    <li role="presentation" class="center-block text-center @if($active == 4 ) active  @endif"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">Boissons ({{count($recettesStatus4)}})</a></li>
                                    <li role="presentation" class="center-block text-center @if($active == 5 ) active  @endif"><a href="#patisseries" aria-controls="patisseries" role="tab" data-toggle="tab">Patisseries ({{count($recettesStatus5)}})</a></li>
                                    @if($filter == true)
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane @if($active == 1 or $active == null) active @endif" id="home">
                                        ...
                                        <div class="col-sm-8">
                                           ...
                                           <h3 class="text-center">{{count($recettesStatus1)}} résultat<?php if(count($recettesStatus1) > 1){echo's';} ?> pour : {{$titleEntree}}</h3>
                                            @endif
                                            <?php $y = 0; ?>
                                                @foreach ($recettesStatus1 as $recette)
                                            <div class="col-md-12 <?php if($y > 5){  echo'dont';  }else{ echo'do'; }?>" id="recette1" data-time="{{$recette->time}}">
                                                <a href="{{  e(url('/recettes/'.$recette->id)) }}" class=""><h2 class="recette-link">{{$recette->title}}</h2></a>
                                                    <div class="col-md-6">
                                                    <div role="tabpanel" class="tab-pane " id="home">
                                                        <img src="https://img.youtube.com/vi/{{ $recette->picture }}/hqdefault.jpg"  class="img-fluid" alt="">
                                                    </div>
                                                    </div>
                                                    <div class="col-md-6 ">
                                                        <div class="recette-detail">
                                                           <p><i class="fa fa-clock-o"></i>  {{$recette->time}} min - {{$recette->nbPers}} Personnes</p>
                                                           <p>{{$recette->description}}</p>
                                                        <div class="clearfix"></div>
                                                        <p>{{$recette->grade}}</p>
                                                        <a href="{{  e(url('/recettes/'.$recette->id)) }}" class="btn btn-primary"><i class="fa fa-eye"></i>Voir plus</a>
                                                        </div>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-sm-8">
                                                @if(isset($titlePlats) && $titlePlats != null)
                                                    <h3 class="text-center">{{count($recettesStatus2)}} résultat<?php if(count($recettesStatus2) > 1){echo's';} ?> pour : {{$titlePlats}}</h3>
                                                @endif
                                                <?php $y = 0; ?>
                                        @foreach ($recettesStatus2 as $recette)
                                                        <div class="col-md-12 <?php if($y > 5){  echo'dont';  }else{ echo'do'; }?>" id="recette1" data-time="{{$recette->time}}">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-sm-8">
                                                @if(isset($titleDesserts) && $titleDesserts != null)
                                                    <h3 class="text-center">{{count($recettesStatus3)}} résultat<?php if(count($recettesStatus3) > 1){echo 's';}?> pour : {{$titleDesserts}}</h3>
                                                @endif
                                                <?php $y = 0; ?>
                                                @foreach ($recettesStatus3 as $recette)
                                                        <div class="col-md-12 <?php if($y > 5){  echo'dont';  }else{ echo'do'; }?>" id="recette1" data-time="{{$recette->time}}">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-sm-8">
                                                @if(isset($titleBoissons) && $titleBoissons != null)
                                                    <h3 class="text-center">{{count($recettesStatus4)}} résultat<?php if(count($recettesStatus4) > 1){echo's';} ?> pour : {{$titleBoissons}}</h3>
                                                @endif
                                                <?php $y = 0; ?>
                                        @foreach ($recettesStatus4 as $recette)
                                                        <div class="col-md-12 <?php if($y > 5){  echo'dont';  }else{ echo'do'; }?>" id="recette1" data-time="{{$recette->time}}">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-sm-8">
                                                @if(isset($titlePatisseries) && $titlePatisseries != null)
                                                    <h3 class="text-center">{{count($recettesStatus5)}} résultat<?php if(count($recettesStatus5) > 1){ echo 's'; } ?> pour : {{$titlePatisseries}}</h3>
                                                @endif
                                                <?php $y = 0; ?>
                                            @foreach ($recettesStatus5 as $recette)
                                                        <div class="col-md-12 <?php if($y > 5){  echo'dont';  }else{ echo'do'; }?>" id="recette1" data-time="{{$recette->time}}">
